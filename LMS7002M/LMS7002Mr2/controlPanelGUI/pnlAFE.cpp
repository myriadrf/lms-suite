...
cmbISEL_DAC_AFE = new StdCombobox(this, ID_ISEL_DAC_AFE, wxEmptyString, wxDefaultPosition, wxSize(162,21), 0, 0, 0, wxDefaultValidator, _T("ID_ISEL_DAC_AFE"));
...
cmbMUX_AFE_1 = new StdCombobox(this, ID_MUX_AFE_1, wxEmptyString, wxDefaultPosition, wxSize(347,21), 0, 0, 0, wxDefaultValidator, _T("ID_MUX_AFE_1"));
...
cmbMUX_AFE_2 = new StdCombobox(this, ID_MUX_AFE_2, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_MUX_AFE_2"));
...
chkPD_AFE = new wxCheckBox(this, ID_PD_AFE, _("AFE current mirror in BIAS&TOP"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_PD_AFE"));
chkPD_AFE->SetValue(false);
chkPD_AFE->SetToolTip(_("Power down control for the AFE current mirror in BIAS&TOP"));
...
chkEN_G_AFE = new wxCheckBox(this, ID_EN_G_AFE, _("Enable individual power downs"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_EN_G_AFE"));
...
void pnlAFE::Initialize(LMS7002_MainControl *pControl)
{
    ...
    temp.clear();
    temp.push_back("MUX off, only PGA output is connected to ADC input");

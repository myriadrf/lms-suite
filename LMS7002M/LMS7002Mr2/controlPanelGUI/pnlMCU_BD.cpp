...
//    AssignEnumsToIds();
    ...
    rgrMode = new wxRadioBox(this, ID_RADIOBOX1, _("MCU\'s programming mode:"), wxDefaultPosition, wxDefaultSize, 3, __wxRadioBoxChoices_1, 1, 0, wxDefaultValidator, _T("ID_RADIOBOX1"));
    rgrMode->Disable();
    ...
    m_sTestNo = new wxTextCtrl(this, ID_TESTNO, _("Text"), wxDefaultPosition, wxSize(73,21), 0, wxTextValidator(wxFILTER_NUMERIC), _T("ID_TESTNO"));
    ...
    InstrNo = new wxTextCtrl(this, ID_INSTRNO, _("Text"), wxDefaultPosition, wxSize(68,21), 0, wxDefaultValidator, _T("ID_INSTRNO"));
    ...
    DebugModeStaticBoxSizer->Add(FlexGridSizer3, 1, wxALIGN_LEFT|wxALIGN_TOP, 5);
    ...
    TextCtrl1 = new wxTextCtrl(this, ID_TEXTCTRL1, _("Text"), wxDefaultPosition, wxSize(65,21), 0, wxTextValidator(wxFILTER_NUMERIC), _T("ID_TEXTCTRL1"));
    ...
    else
    {
        ...
        for (i=0; i<m_iTestResultFileLine; i++)
            if (TestResultArray_code[i]==m_iTestNo)
            {
                ...
                retval=lmsControl->getMCU_BD()->Three_byte_command(
                           0x78, (unsigned char)(TestResultArray_address[i]), 0x00,
                           &tempc1, &tempc2, &tempc3);
                if (retval==-1) i=m_iTestResultFileLine;
                else if  (tempc3!=TestResultArray_value[i])
                {
                    i=m_iTestResultFileLine;
                    m_iError=1;
                }

...
const long pnlLimeLightPAD::ID_DLB_MUX = wxNewId();
...
void pnlLimeLightPAD::AssignEnumsToIds()
{
    ...
    wndId2Enum[ID_LML1_RX_PRE] = LML1_RX_PRE;
    wndId2Enum[ID_LML1_RX_PST] = LML1_RX_PST;
    ...
    wndId2Enum[ID_LML1_TX_PRE] = LML1_TX_PRE;
    wndId2Enum[ID_LML1_TX_PST] = LML1_TX_PST;
    ...
    wndId2Enum[ID_LML2_RX_PRE] = LML2_RX_PRE;
    wndId2Enum[ID_LML2_RX_PST] = LML2_RX_PST;
    ...
    wndId2Enum[ID_LML2_TX_PRE] = LML2_TX_PRE;
    wndId2Enum[ID_LML2_TX_PST] = LML2_TX_PST;
    wndId2Enum[ID_LML_MODE1] = LML_MODE1;
    wndId2Enum[ID_LML_MODE2] = LML_MODE2;
    wndId2Enum[ID_LML_TXNRXIQ1] = LML_TXNRXIQ1;
    wndId2Enum[ID_LML_TXNRXIQ2] = LML_TXNRXIQ2;
    ...
    wndId2Enum[ID_LML_FIDM1] = LML_FIDM1;
    wndId2Enum[ID_LML_FIDM2] = LML_FIDM2;
}
...
chkTX_CLK_PE = new wxCheckBox(Panel1, ID_TX_CLK_PE, _("Engage pull up of TX&CLK pad"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TX_CLK_PE"));
chkTX_CLK_PE->SetValue(false);
chkTX_CLK_PE->SetToolTip(_("Pull up control of TX&CLK pad"));
Pullupcontrol3Sizer->Add(chkTX_CLK_PE, 0, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 0);
chkRX_CLK_PE = new wxCheckBox(Panel1, ID_RX_CLK_PE, _("Engage pull up of RX&CLK pad"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RX_CLK_PE"));
chkRX_CLK_PE->SetValue(false);
chkRX_CLK_PE->SetToolTip(_("Pull up control of RX&CLK pad"));
...
chkIQ_SEL_EN_2_PE = new wxCheckBox(Panel1, ID_IQ_SEL_EN_2_PE, _("Engage pull up of IQ&SEL&EN&2 pad"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_IQ_SEL_EN_2_PE"));
chkIQ_SEL_EN_2_PE->SetValue(false);
chkIQ_SEL_EN_2_PE->SetToolTip(_("Pull up control of IQ&SEL&EN&2 pad"));
...
chkIQ_SEL_EN_1_PE = new wxCheckBox(Panel1, ID_IQ_SEL_EN_1_PE, _("Engage pull up of IQ&SEL&EN&1 pad"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_IQ_SEL_EN_1_PE"));
chkIQ_SEL_EN_1_PE->SetValue(false);
chkIQ_SEL_EN_1_PE->SetToolTip(_("Pull up control of IQ&SEL&EN&1 pad"));
...
rgrLML_FIDM1->SetToolTip(_("Frame start ID selection for Port 1 when LML&MODE1 = 0"));
...
rgrLML_FIDM2->SetToolTip(_("Frame start ID selection for Port 2 when LML&MODE2 = 0"));
...
rgrLML_TXNRXIQ1->SetToolTip(_("TXIQ/RXIQ mode selection for Port 1 when LML&MODE1 = 0"));
...
rgrLML_TXNRXIQ2->SetToolTip(_("TXIQ/RXIQ mode selection for Port 2 when LML&MODE2 = 0"));
...
StaticText33 = new wxStaticText(Panel1, ID_STATICTEXT33, _("Digital loopback"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT33"));
UNGROUPED13Sizer->Add(StaticText33, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 0);
cmbDLB_MUX = new StdCombobox(Panel1, ID_DLB_MUX, wxEmptyString, wxDefaultPosition, wxSize(196,21), 0, 0, 0, wxDefaultValidator, _T("ID_DLB_MUX"));
cmbDLB_MUX->SetToolTip(_("Digital loop back selection"));
UNGROUPED13Sizer->Add(cmbDLB_MUX, 0, wxLEFT|wxEXPAND|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
...
cmbTX_MUX = new StdCombobox(Panel1, ID_TX_MUX, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_TX_MUX"));
...
cmbMIMO_SISO = new StdCombobox(Panel1, ID_MIMO_SISO, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_MIMO_SISO"));
...
rgrMAC = new wxRadioBox(Panel1, ID_MAC, _("MIMO access control"), wxDefaultPosition, wxDefaultSize, 4, __wxRadioBoxChoices_13, 1, wxRA_SPECIFY_COLS, wxDefaultValidator, _T("ID_MAC"));
...
SamplesourcewhenPort1isTxSizer = new wxStaticBoxSizer(wxHORIZONTAL, Panel2, _("Sample source when Port 1 is Tx"));
...
cmbLML1_S3S = new StdCombobox(Panel2, ID_LML1_S3S, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LML1_S3S"));
cmbLML1_S3S->SetToolTip(_("Sample source in position 3, when Port 1 is TX"));
...
cmbLML1_S2S = new StdCombobox(Panel2, ID_LML1_S2S, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LML1_S2S"));
cmbLML1_S2S->SetToolTip(_("Sample source in position 2, when Port 1 is TX"));
...
cmbLML1_S1S = new StdCombobox(Panel2, ID_LML1_S1S, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LML1_S1S"));
cmbLML1_S1S->SetToolTip(_("Sample source in position 1, when Port 1 is TX"));
...
cmbLML1_S0S = new StdCombobox(Panel2, ID_LML1_S0S, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LML1_S0S"));
cmbLML1_S0S->SetToolTip(_("Sample source in position 0, when Port 1 is TX"));
...
SamplepositionswhenPort1isRxSizer = new wxStaticBoxSizer(wxHORIZONTAL, Panel2, _("Sample positions when Port 1 is Rx"));
...
cmbLML1_BQP = new StdCombobox(Panel2, ID_LML1_BQP, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LML1_BQP"));
cmbLML1_BQP->SetToolTip(_("BQ sample position in frame, when Port 1 is RX"));
...
cmbLML1_BIP = new StdCombobox(Panel2, ID_LML1_BIP, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LML1_BIP"));
cmbLML1_BIP->SetToolTip(_("BI sample position in frame, when Port 1 is RX"));
...
cmbLML1_AQP = new StdCombobox(Panel2, ID_LML1_AQP, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LML1_AQP"));
cmbLML1_AQP->SetToolTip(_("AQ sample position in frame, when Port 1 is RX"));
...
cmbLML1_AIP = new StdCombobox(Panel2, ID_LML1_AIP, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LML1_AIP"));
cmbLML1_AIP->SetToolTip(_("AI sample position in frame, when Port 1 is RX"));
...
SamplesourcewhenPort2isTxSizer = new wxStaticBoxSizer(wxHORIZONTAL, Panel2, _("Sample source when Port 2 is Tx"));
...
cmbLML2_S3S = new StdCombobox(Panel2, ID_LML2_S3S, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LML2_S3S"));
cmbLML2_S3S->SetToolTip(_("Sample source in position 3, when Port 2 is TX"));
...
cmbLML2_S2S = new StdCombobox(Panel2, ID_LML2_S2S, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LML2_S2S"));
cmbLML2_S2S->SetToolTip(_("Sample source in position 2, when Port 2 is TX"));
...
cmbLML2_S1S = new StdCombobox(Panel2, ID_LML2_S1S, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LML2_S1S"));
cmbLML2_S1S->SetToolTip(_("Sample source in position 1, when Port 2 is TX"));
...
cmbLML2_S0S = new StdCombobox(Panel2, ID_LML2_S0S, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LML2_S0S"));
cmbLML2_S0S->SetToolTip(_("Sample source in position 0, when Port 2 is TX"));
...
SamplepositionswhenPort2isRxSizer = new wxStaticBoxSizer(wxHORIZONTAL, Panel2, _("Sample positions when Port 2 is Rx"));
...
cmbLML2_BQP = new StdCombobox(Panel2, ID_LML2_BQP, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LML2_BQP"));
cmbLML2_BQP->SetToolTip(_("BQ sample position in frame, when Port 2 is RX"));
...
cmbLML2_BIP = new StdCombobox(Panel2, ID_LML2_BIP, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LML2_BIP"));
cmbLML2_BIP->SetToolTip(_("BI sample position in frame, when Port 2is RX"));
...
cmbLML2_AQP = new StdCombobox(Panel2, ID_LML2_AQP, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LML2_AQP"));
cmbLML2_AQP->SetToolTip(_("AQ sample position in frame, when Port 2 is RX"));
...
cmbLML2_AIP = new StdCombobox(Panel2, ID_LML2_AIP, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LML2_AIP"));
cmbLML2_AIP->SetToolTip(_("AI sample position in frame, when Port 2 is RX"));
...
FlexGridSizer4->Add(FlexGridSizer5, 1, wxLEFT|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
...
cmbTXRDCLK_MUX = new StdCombobox(Panel2, ID_TXRDCLK_MUX, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_TXRDCLK_MUX"));
...
cmbTXWRCLK_MUX = new StdCombobox(Panel2, ID_TXWRCLK_MUX, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_TXWRCLK_MUX"));
...
cmbRXRDCLK_MUX = new StdCombobox(Panel2, ID_RXRDCLK_MUX, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RXRDCLK_MUX"));
...
cmbRXWRCLK_MUX = new StdCombobox(Panel2, ID_RXWRCLK_MUX, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RXWRCLK_MUX"));
...
cmbMCLK2SRC = new StdCombobox(Panel2, ID_MCLK2SRC, wxEmptyString, wxDefaultPosition, wxSize(159,21), 0, 0, 0, wxDefaultValidator, _T("ID_MCLK2SRC"));
...
cmbMCLK1SRC = new StdCombobox(Panel2, ID_MCLK1SRC, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_MCLK1SRC"));
...
cmbTXTSPCLKA_DIV = new StdCombobox(Panel2, ID_TXTSPCLKA_DIV, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_TXTSPCLKA_DIV"));
cmbTXTSPCLKA_DIV->SetToolTip(_("TxTSP clock divider, used to produce MCLK(1/2) clocks"));
...
cmbRXTSPCLKA_DIV = new StdCombobox(Panel2, ID_RXTSPCLKA_DIV, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RXTSPCLKA_DIV"));
cmbRXTSPCLKA_DIV->SetToolTip(_("RxTSP clock divider, used to produce MCLK(1/2) clocks"));
...
FlexGridSizer4->Add(ClockcontrolsSizer, 1, wxLEFT|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
...
cmbLML1_TX_PST = new StdCombobox(Panel2, ID_LML1_TX_PST, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LML1_TX_PST"));
cmbLML1_TX_PST->SetToolTip(_("Number of clock cycles to wait before data drive stop after burst stop is detected in JESD207 mode on Port 1 and Port 1 is transmitter."));
...
cmbLML1_TX_PRE = new StdCombobox(Panel2, ID_LML1_TX_PRE, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LML1_TX_PRE"));
cmbLML1_TX_PRE->SetToolTip(_("Number of clock cycles to wait before data drive start after burst start is detected in JESD207 mode on Port 1 and Port 1 is transmitter."));
...
cmbLML1_RX_PST = new StdCombobox(Panel2, ID_LML1_RX_PST, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LML1_RX_PST"));
cmbLML1_RX_PST->SetToolTip(_("Number of clock cycles to wait before data capture stop after burst stop is detected in JESD207 mode on Port 1 and Port 1 is receiver."));
...
cmbLML1_RX_PRE = new StdCombobox(Panel2, ID_LML1_RX_PRE, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LML1_RX_PRE"));
cmbLML1_RX_PRE->SetToolTip(_("Number of clock cycles to wait before data capture start after burst start is detected in JESD207 mode on Port 1 and Port 1 is receiver."));
...
cmbLML2_TX_PST = new StdCombobox(Panel2, ID_LML2_TX_PST, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LML2_TX_PST"));
cmbLML2_TX_PST->SetToolTip(_("Number of clock cycles to wait before data drive stop after burst stop is detected in JESD207 mode on Port 2 and Port 2 is transmitter."));
...
cmbLML2_TX_PRE = new StdCombobox(Panel2, ID_LML2_TX_PRE, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LML2_TX_PRE"));
cmbLML2_TX_PRE->SetToolTip(_("Number of clock cycles to wait before data drive start after burst start is detected in JESD207 mode on Port 2 and Port 2 is transmitter."));
...
cmbLML2_RX_PST = new StdCombobox(Panel2, ID_LML2_RX_PST, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LML2_RX_PST"));
cmbLML2_RX_PST->SetToolTip(_("Number of clock cycles to wait before data capture stop after burst stop is detected in JESD207 mode on Port 2 and Port 2 is receiver."));
...
cmbLML2_RX_PRE = new StdCombobox(Panel2, ID_LML2_RX_PRE, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LML2_RX_PRE"));
cmbLML2_RX_PRE->SetToolTip(_("Number of clock cycles to wait before data capture start after burst start is detected in JESD207 mode on Port 2 and Port 2 is receiver."));
...
FlexGridSizer3->Add(FlexGridSizer6, 1, wxLEFT|wxALIGN_LEFT|wxALIGN_TOP, 5);
...
Connect(ID_DLB_MUX,wxEVT_COMMAND_COMBOBOX_SELECTED,(wxObjectEventFunction)&pnlLimeLightPAD::ParameterChangeHandler);
...
void pnlLimeLightPAD::Initialize(LMS7002_MainControl *pControl)
{
    ...
    vector<string> temp;
    temp.clear();
    temp.push_back("Normal mode operation");
    temp.push_back("Digital loop back mode is active");
    cmbDLB_MUX->Clear();
    cmbDLB_MUX->Append(temp);
    cmbDLB_MUX->SetSelection( lmsControl->GetParam(DLB_MUX));
    ...
    cmbLML1_RX_PRE->SetSelection( lmsControl->GetParam(LML1_RX_PRE));
    ...
    cmbLML1_RX_PST->SetSelection( lmsControl->GetParam(LML1_RX_PST));
    ...
    cmbLML1_TX_PRE->SetSelection( lmsControl->GetParam(LML1_TX_PRE));
    ...
    cmbLML1_TX_PST->SetSelection( lmsControl->GetParam(LML1_TX_PST));
    ...
    cmbLML2_RX_PRE->SetSelection( lmsControl->GetParam(LML2_RX_PRE));
    ...
    cmbLML2_RX_PST->SetSelection( lmsControl->GetParam(LML2_RX_PST));
    ...
    cmbLML2_TX_PRE->SetSelection( lmsControl->GetParam(LML2_TX_PRE));
    ...
    cmbLML2_TX_PST->SetSelection( lmsControl->GetParam(LML2_TX_PST));
...
void pnlLimeLightPAD::UpdateGUI()
{
    ...
    value = lmsControl->GetParam(DLB_MUX);
    cmbDLB_MUX->SetSelection(value);
    ...
    value = lmsControl->GetParam(LML1_RX_PRE);
    cmbLML1_RX_PRE->SetSelection(value);

    value = lmsControl->GetParam(LML1_RX_PST);
    ...
    value = lmsControl->GetParam(LML1_TX_PRE);
    cmbLML1_TX_PRE->SetSelection(value);

    value = lmsControl->GetParam(LML1_TX_PST);
    ...
    value = lmsControl->GetParam(LML2_RX_PRE);
    cmbLML2_RX_PRE->SetSelection(value);

    value = lmsControl->GetParam(LML2_RX_PST);
    ...
    value = lmsControl->GetParam(LML2_TX_PRE);
    cmbLML2_TX_PRE->SetSelection(value);

    value = lmsControl->GetParam(LML2_TX_PST);
    cmbLML2_TX_PST->SetSelection(value);

    value = lmsControl->GetParam(LML_MODE1);
    rgrLML_MODE1->SetSelection(value);

    value = lmsControl->GetParam(LML_MODE2);
    rgrLML_MODE2->SetSelection(value);

    value = lmsControl->GetParam(LML_TXNRXIQ1);
    rgrLML_TXNRXIQ1->SetSelection(value);

    value = lmsControl->GetParam(LML_TXNRXIQ2);

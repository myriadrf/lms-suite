...
void pnlADF::BuildContent(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
    ...
    cmbLDP = new StdCombobox(this, ID_COMBOBOX1, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX1"));
    ...
    cmbABW = new StdCombobox(this, ID_COMBOBOX2, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX2"));
    ...
    cmbCPG = new StdCombobox(this, ID_COMBOBOX3, wxEmptyString, wxDefaultPosition, wxSize(65,21), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX3"));
    ...
    spinNCnt = new wxSpinCtrl(this, ID_SPINCTRL2, _T("384"), wxDefaultPosition, wxSize(70,21), 0, 0, 8191, 384, _T("ID_SPINCTRL2"));
    ...
    cmbCS1_f = new StdCombobox(this, ID_COMBOBOX4, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX4"));
    cmbCS1_f->Append(_("0"));
    cmbCS1_f->Append(_("1"));
    cmbCS1_f->Append(_("2"));
    cmbCS1_f->Append(_("3"));
    ...
    cmbTC_f = new StdCombobox(this, ID_COMBOBOX5, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX5"));
    ...
    cmbCS2_f = new StdCombobox(this, ID_COMBOBOX6, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX6"));
    cmbCS2_f->Append(_("0"));
    cmbCS2_f->Append(_("1"));
    cmbCS2_f->Append(_("2"));
    cmbCS2_f->Append(_("3"));
    ...
    cmbFL_f = new StdCombobox(this, ID_COMBOBOX7, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX7"));
    ...
    cmbMOC_f = new StdCombobox(this, ID_COMBOBOX8, wxEmptyString, wxDefaultPosition, wxSize(160,21), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX8"));
    ...
    cmbCS1_i = new StdCombobox(this, ID_COMBOBOX9, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX9"));
    cmbCS1_i->Append(_("0"));
    cmbCS1_i->Append(_("1"));
    cmbCS1_i->Append(_("2"));
    cmbCS1_i->Append(_("3"));
    ...
    cmbTC_i = new StdCombobox(this, ID_COMBOBOX10, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX10"));
    ...
    cmbCS2_i = new StdCombobox(this, ID_COMBOBOX11, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX11"));
    cmbCS2_i->Append(_("0"));
    cmbCS2_i->Append(_("1"));
    cmbCS2_i->Append(_("2"));
    cmbCS2_i->Append(_("3"));
    ...
    cmbFL_i = new StdCombobox(this, ID_COMBOBOX12, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX12"));
    ...
    cmbMOC_i = new StdCombobox(this, ID_COMBOBOX13, wxEmptyString, wxDefaultPosition, wxSize(160,21), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX13"));

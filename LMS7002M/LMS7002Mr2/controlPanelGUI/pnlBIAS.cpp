...
const long pnlBIAS::ID_EN_BIAS_MASTER = wxNewId();
const long pnlBIAS::ID_EN_G_BIAS = wxNewId();
...
{
    wndId2Enum[ID_EN_BIAS_MASTER] = EN_BIAS_MASTER;
...
chkEN_BIAS_MASTER = new wxCheckBox(this, ID_EN_BIAS_MASTER, _("Enable Central bias block"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_EN_BIAS_MASTER"));
chkEN_BIAS_MASTER->SetValue(false);
chkEN_BIAS_MASTER->SetToolTip(_("Enable signal for central bias block"));
Powerdowncontrols1Sizer->Add(chkEN_BIAS_MASTER, 0, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 0);
chkEN_G_BIAS = new wxCheckBox(this, ID_EN_G_BIAS, _("Enable individual power downs"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_EN_G_BIAS"));
chkEN_G_BIAS->SetValue(false);
chkEN_G_BIAS->SetToolTip(_("Enable control for all the BIAS power downs"));
Powerdowncontrols1Sizer->Add(chkEN_G_BIAS, 0, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 0);
...
StaticText0 = new wxStaticText(this, ID_STATICTEXT1, _("BIAS&TOP test mode"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT1"));
BIAS2Sizer->Add(StaticText0, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 0);
cmbMUX_BIAS_OUT = new StdCombobox(this, ID_MUX_BIAS_OUT, wxEmptyString, wxDefaultPosition, wxSize(339,21), 0, 0, 0, wxDefaultValidator, _T("ID_MUX_BIAS_OUT"));
cmbMUX_BIAS_OUT->SetToolTip(_("Test mode of the BIAS&TOP"));
...
cmbRP_CALIB_BIAS = new StdCombobox(this, ID_RP_CALIB_BIAS, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RP_CALIB_BIAS"));
...
Connect(ID_EN_BIAS_MASTER,wxEVT_COMMAND_CHECKBOX_CLICKED,(wxObjectEventFunction)&pnlBIAS::ParameterChangeHandler);
Connect(ID_EN_G_BIAS,wxEVT_COMMAND_CHECKBOX_CLICKED,(wxObjectEventFunction)&pnlBIAS::ParameterChangeHandler);
...
void pnlBIAS::UpdateGUI()
{
    //GetParent()->Freeze();
    long value = 0;
    value = lmsControl->GetParam(EN_BIAS_MASTER);
    chkEN_BIAS_MASTER->SetValue(value);

    value = lmsControl->GetParam(EN_G_BIAS);
    chkEN_G_BIAS->SetValue(value);

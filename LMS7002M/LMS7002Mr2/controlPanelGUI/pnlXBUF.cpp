...
chkSLFB_XBUF_RX->SetToolTip(_("Self biasing digital contol SLFB&XBUF&RX"));
...
chkSLFB_XBUF_TX->SetToolTip(_("Self biasing digital contol SLFB&XBUF&TX"));
...
chkEN_OUT2_XBUF_TX->SetToolTip(_("Enables the 2nd output of TX XBUF. This 2nd buffer goes to XBUF&RX. This should be active when only 1 XBUF is to be used"));
...
chkPD_XBUF_RX->SetToolTip(_("Power down signal PD&XBUF&RX"));
...
chkPD_XBUF_TX->SetToolTip(_("Power down signal PD&XBUF&TX"));
Powerdowncontrols1Sizer->Add(chkPD_XBUF_TX, 0, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 0);
chkEN_G_XBUF = new wxCheckBox(this, ID_EN_G_XBUF, _("Enable individual power downs"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_EN_G_XBUF"));

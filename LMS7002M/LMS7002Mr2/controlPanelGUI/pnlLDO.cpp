...
const long pnlLDO::ID_EN_LDO_DIGIp1 = wxNewId();
const long pnlLDO::ID_EN_LDO_DIGIp2 = wxNewId();
...
const long pnlLDO::ID_EN_LDO_SPIBUF = wxNewId();
...
void pnlLDO::AssignEnumsToIds()
{
    ...
    wndId2Enum[ID_EN_LDO_DIGIp1] = EN_LDO_DIGIp1;
    wndId2Enum[ID_EN_LDO_DIGIp2] = EN_LDO_DIGIp2;
    ...
    wndId2Enum[ID_EN_LDO_SPIBUF] = EN_LDO_SPIBUF;
...
chkEN_G_LDOP = new wxCheckBox(Panel3, ID_EN_G_LDOP, _("Enable individual power downs digital"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_EN_G_LDOP"));
...
chkEN_G_LDO = new wxCheckBox(Panel3, ID_EN_G_LDO, _("Enable individual power downs analog"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_EN_G_LDO"));
...
chkEN_LDO_DIGIp1 = new wxCheckBox(Panel3, ID_EN_LDO_DIGIp1, _("EN_LDO_DIGIp1"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_EN_LDO_DIGIp1"));
chkEN_LDO_DIGIp1->SetValue(false);
chkEN_LDO_DIGIp1->SetToolTip(_("Enables the LDO"));
StaticBoxSizer5->Add(chkEN_LDO_DIGIp1, 0, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 0);
chkEN_LDO_DIGIp2 = new wxCheckBox(Panel3, ID_EN_LDO_DIGIp2, _("EN_LDO_DIGIp2"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_EN_LDO_DIGIp2"));
chkEN_LDO_DIGIp2->SetValue(false);
chkEN_LDO_DIGIp2->SetToolTip(_("Enables the LDO"));
StaticBoxSizer5->Add(chkEN_LDO_DIGIp2, 0, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 0);
...
chkEN_LDO_SPIBUF = new wxCheckBox(Panel3, ID_EN_LDO_SPIBUF, _("EN_LDO_SPIBUF"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_EN_LDO_SPIBUF"));
chkEN_LDO_SPIBUF->SetValue(false);
chkEN_LDO_SPIBUF->SetToolTip(_("Enables the LDO"));
StaticBoxSizer8->Add(chkEN_LDO_SPIBUF, 0, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 0);
...
cmbRDIV_VCOSXR = new StdCombobox(Panel2, ID_RDIV_VCOSXR, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_VCOSXR"));
...
cmbRDIV_VCOSXT = new StdCombobox(Panel2, ID_RDIV_VCOSXT, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_VCOSXT"));
...
cmbRDIV_TXBUF = new StdCombobox(Panel2, ID_RDIV_TXBUF, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_TXBUF"));
...
cmbRDIV_VCOGN = new StdCombobox(Panel2, ID_RDIV_VCOGN, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_VCOGN"));
...
cmbRDIV_TLOB = new StdCombobox(Panel2, ID_RDIV_TLOB, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_TLOB"));
...
cmbRDIV_TPAD = new StdCombobox(Panel2, ID_RDIV_TPAD, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_TPAD"));
...
cmbRDIV_TIA12 = new StdCombobox(Panel2, ID_RDIV_TIA12, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_TIA12"));
...
cmbRDIV_TIA14 = new StdCombobox(Panel2, ID_RDIV_TIA14, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_TIA14"));
...
cmbRDIV_RXBUF = new StdCombobox(Panel2, ID_RDIV_RXBUF, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_RXBUF"));
...
cmbRDIV_TBB = new StdCombobox(Panel2, ID_RDIV_TBB, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_TBB"));
...
cmbRDIV_MXRFE = new StdCombobox(Panel2, ID_RDIV_MXRFE, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_MXRFE"));
...
cmbRDIV_RBB = new StdCombobox(Panel2, ID_RDIV_RBB, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_RBB"));
...
cmbRDIV_LNA12 = new StdCombobox(Panel2, ID_RDIV_LNA12, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_LNA12"));
...
cmbRDIV_LNA14 = new StdCombobox(Panel2, ID_RDIV_LNA14, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_LNA14"));
...
cmbRDIV_DIVSXR = new StdCombobox(Panel2, ID_RDIV_DIVSXR, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_DIVSXR"));
...
cmbRDIV_DIVSXT = new StdCombobox(Panel2, ID_RDIV_DIVSXT, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_DIVSXT"));
...
cmbRDIV_DIGSXT = new StdCombobox(Panel2, ID_RDIV_DIGSXT, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_DIGSXT"));
...
cmbRDIV_DIVGN = new StdCombobox(Panel2, ID_RDIV_DIVGN, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_DIVGN"));
...
cmbRDIV_DIGGN = new StdCombobox(Panel2, ID_RDIV_DIGGN, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_DIGGN"));
...
cmbRDIV_DIGSXR = new StdCombobox(Panel2, ID_RDIV_DIGSXR, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_DIGSXR"));
...
cmbRDIV_CPSXT = new StdCombobox(Panel2, ID_RDIV_CPSXT, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_CPSXT"));
...
cmbRDIV_DIG = new StdCombobox(Panel2, ID_RDIV_DIG, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_DIG"));
...
cmbRDIV_CPGN = new StdCombobox(Panel2, ID_RDIV_CPGN, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_CPGN"));
...
cmbRDIV_CPSXR = new StdCombobox(Panel2, ID_RDIV_CPSXR, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_CPSXR"));
...
cmbRDIV_SPIBUF = new StdCombobox(Panel2, ID_RDIV_SPIBUF, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_SPIBUF"));
...
cmbRDIV_AFE = new StdCombobox(Panel2, ID_RDIV_AFE, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_AFE"));
...
cmbRDIV_DIGIp2 = new StdCombobox(Panel2, ID_RDIV_DIGIp2, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_DIGIp2"));
...
cmbRDIV_DIGIp1 = new StdCombobox(Panel2, ID_RDIV_DIGIp1, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_RDIV_DIGIp1"));
...
FlexGridSizer3->Add(OutputvoltageSizer, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
...
Connect(ID_EN_LDO_DIGIp1,wxEVT_COMMAND_CHECKBOX_CLICKED,(wxObjectEventFunction)&pnlLDO::ParameterChangeHandler);
Connect(ID_EN_LDO_DIGIp2,wxEVT_COMMAND_CHECKBOX_CLICKED,(wxObjectEventFunction)&pnlLDO::ParameterChangeHandler);
...
Connect(ID_EN_LDO_SPIBUF,wxEVT_COMMAND_CHECKBOX_CLICKED,(wxObjectEventFunction)&pnlLDO::ParameterChangeHandler);
...
void pnlLDO::UpdateGUI()
{
    ...
    value = lmsControl->GetParam(EN_LDO_DIGIp1);
    chkEN_LDO_DIGIp1->SetValue(value);

    value = lmsControl->GetParam(EN_LDO_DIGIp2);
    chkEN_LDO_DIGIp2->SetValue(value);
    ...
    value = lmsControl->GetParam(EN_LDO_SPIBUF);
    chkEN_LDO_SPIBUF->SetValue(value);

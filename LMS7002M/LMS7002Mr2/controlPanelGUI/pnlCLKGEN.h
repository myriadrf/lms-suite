...
StdCombobox* cmbCZ_CGEN;
wxStaticText* StaticText11;
wxButton* btnTune;
wxStaticText* StaticText18;
StdCombobox* cmbIPULSE_CP_CGEN;
StdCombobox* cmbIOFFSET_CP_CGEN;
wxCheckBox* chkPD_CP_CGEN;
StdCombobox* cmbEN_DACCLKH_CLKGN;
wxCheckBox* chkREV_SDMCLK_CGEN;
wxStaticText* lblVCO_CMPHO_CGEN;
wxStaticText* StaticText1;
wxStaticText* StaticText3;
StdCombobox* cmbICT_VCO_CGEN;
...
StdCombobox* cmbCP3_CGEN;
wxStaticText* lblVCO_CMPLO_CGEN;
StdCombobox* cmbCSW_VCO_CGEN;
...
static const long ID_EN_DACCLKH_CLKGN;

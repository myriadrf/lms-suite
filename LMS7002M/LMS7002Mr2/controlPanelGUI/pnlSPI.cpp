...
void pnlSPI::BuildContent(wxWindow* parent, wxWindowID id)
{
    ...
    FlexGridSizer13->Add(btnBatchRead, 1, wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ...
    FlexGridSizer13->Add(chkSaveToFileBatch, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    ...
    FlexGridSizer13->Add(btnWrTester, 1, wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ...
    chkTripleCheck->SetValue(true);
    chkTripleCheck->SetToolTip(_("When reading, reads the same register three times and uses the most frequent value"));
    FlexGridSizer13->Add(chkTripleCheck, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ...
    FlexGridSizer13->Add(chkTestWrittenData, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    FlexGridSizer3->Add(FlexGridSizer13, 1, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ...
    StaticBoxSizer3 = new wxStaticBoxSizer(wxHORIZONTAL, this, _("Registers Test"));
    ...
    FlexGridSizer5->Add(StaticBoxSizer3, 1, wxEXPAND|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    FlexGridSizer1->Add(FlexGridSizer5, 1, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
...
{
    int readCount = chkTripleCheck->GetValue() == true ? 3 : 1;
    unsigned char outbuffer[64];
    unsigned char inbuffer[readCount][64];
    unsigned char status = 0;

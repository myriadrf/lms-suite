...
const long pnlCLKGEN::ID_EN_DACCLKH_CLKGN = wxNewId();
...
void pnlCLKGEN::AssignEnumsToIds()
{
    ...
    wndId2Enum[ID_EN_DACCLKH_CLKGN] = EN_DACCLKH_CLKGN;
...
chkEN_SDM_TSTO_CGEN->SetToolTip(_("Enables the SDM&TSTO"));
...
cmbEN_DACCLKH_CLKGN = new StdCombobox(this, ID_EN_DACCLKH_CLKGN, wxEmptyString, wxDefaultPosition, wxSize(179,21), 0, 0, 0, wxDefaultValidator, _T("ID_EN_DACCLKH_CLKGN"));
cmbEN_DACCLKH_CLKGN->SetToolTip(_("Selects if F&CLKH or F&CLKL is connected to FCLK&ADC"));
UNGROUPED1Sizer->Add(cmbEN_DACCLKH_CLKGN, 0, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 0);
...
cmbTST_CGEN = new StdCombobox(this, ID_TST_CGEN, wxEmptyString, wxDefaultPosition, wxSize(212,21), 0, 0, 0, wxDefaultValidator, _T("ID_TST_CGEN"));
...
chkREV_CLKDAC_CGEN = new wxCheckBox(this, ID_REV_CLKDAC_CGEN, _("REV_CLKDAC_CGEN"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_REV_CLKDAC_CGEN"));
...
chkREV_CLKADC_CGEN = new wxCheckBox(this, ID_REV_CLKADC_CGEN, _("REV_CLKADC_CGEN"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_REV_CLKADC_CGEN"));
...
chkCOARSE_START_CGEN->SetToolTip(_("Control signal for coarse tuning algorithm (SX&SWC&calibration)"));
...
chkEN_G_CGEN = new wxCheckBox(this, ID_EN_G_CGEN, _("Enable individual power downs"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_EN_G_CGEN"));
...
cmbCSW_VCO_CGEN = new StdCombobox(this, ID_CSW_VCO_CGEN, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_CSW_VCO_CGEN"));
...
cmbICT_VCO_CGEN = new StdCombobox(this, ID_ICT_VCO_CGEN, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_ICT_VCO_CGEN"));
...
PLLfilterSizer = new wxStaticBoxSizer(wxHORIZONTAL, this, _("PLL filter"));
...
cmbCP2_CGEN = new StdCombobox(this, ID_CP2_CGEN, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_CP2_CGEN"));
...
cmbCP3_CGEN = new StdCombobox(this, ID_CP3_CGEN, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_CP3_CGEN"));
...
cmbCZ_CGEN = new StdCombobox(this, ID_CZ_CGEN, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_CZ_CGEN"));
...
FlexGridSizer2->Add(PLLfilterSizer, 1, wxLEFT|wxALIGN_LEFT|wxALIGN_TOP, 5);
...
cmbIOFFSET_CP_CGEN = new StdCombobox(this, ID_IOFFSET_CP_CGEN, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_IOFFSET_CP_CGEN"));
...
cmbIPULSE_CP_CGEN = new StdCombobox(this, ID_IPULSE_CP_CGEN, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_IPULSE_CP_CGEN"));
...
FlexGridSizer2->Add(ChargepumpSizer, 1, wxLEFT|wxALIGN_LEFT|wxALIGN_TOP, 5);
...
txtFrequency = new wxTextCtrl(this, ID_TEXTCTRL1, _("600"), wxDefaultPosition, wxSize(48,21), 0, wxDefaultValidator, _T("ID_TEXTCTRL1"));
FlexGridSizer3->Add(txtFrequency, 1, wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
cmbCLKH_OV_CLKL_CGEN = new StdCombobox(this, ID_CLKH_OV_CLKL_CGEN, wxEmptyString, wxDefaultPosition, wxSize(48,21), 0, 0, 0, wxDefaultValidator, _T("ID_CLKH_OV_CLKL_CGEN"));
...
txtFrequencyCLKL = new wxTextCtrl(this, ID_TEXTCTRL2, _("0"), wxDefaultPosition, wxSize(48,21), wxTE_READONLY, wxDefaultValidator, _T("ID_TEXTCTRL2"));
...
FlexGridSizer6->Add(StaticBoxSizer2, 1, wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
...
lblRefClk_MHz = new wxStaticText(this, ID_STATICTEXT24, _("\?\?\?"), wxDefaultPosition, wxSize(93,13), 0, _T("ID_STATICTEXT24"));
...
Connect(ID_EN_DACCLKH_CLKGN,wxEVT_COMMAND_COMBOBOX_SELECTED,(wxObjectEventFunction)&pnlCLKGEN::ParameterChangeHandler);
...
void pnlCLKGEN::ParameterChangeHandler(wxCommandEvent& event)
{
    ...
    case CLKH_OV_CLKL_CGEN:
        ...
        txtFrequencyCLKL->SetLabel( wxString::Format("%.3f", cgenFreq/pow(2.0, cmbCLKH_OV_CLKL_CGEN->GetSelection())));
    break;
    default:
        lmsControl->SetParam( parameter, event.GetInt());
    }
...
void pnlCLKGEN::Initialize(LMS7002_MainControl *pControl)
{
    ...
    cmbCLKH_OV_CLKL_CGEN->Append(temp);
    cmbCLKH_OV_CLKL_CGEN->SetSelection( lmsControl->GetParam(CLKH_OV_CLKL_CGEN));

    temp.clear();
    for(int i=0; i<16; ++i)
        {sprintf(ctemp, "%.3f fF", i*6*63.2); temp.push_back(ctemp);}
    cmbCP2_CGEN->Clear();
    ...
    temp.clear();
    for(int i=0; i<16; ++i)
        {sprintf(ctemp, "%.3f fF", i*248.0); temp.push_back(ctemp);}
    cmbCP3_CGEN->Clear();
    ...
    temp.clear();
    for(int i=0; i<16; ++i)
        {sprintf(ctemp, "%.3f fF", i*8*365.0); temp.push_back(ctemp);}
    cmbCZ_CGEN->Clear();
...
//    temp.push_back("FCLK_ADC=F_CLKL & FCLK_DAC=F_CLKH");
    ...
    cmbEN_DACCLKH_CLKGN->Clear();
    cmbEN_DACCLKH_CLKGN->Append(temp);
    cmbEN_DACCLKH_CLKGN->SetSelection( lmsControl->GetParam(EN_DACCLKH_CLKGN));
...
//    cmbDIV_OUTCH_CGEN->SetSelection(value);
    ...
    value = lmsControl->GetParam(EN_DACCLKH_CLKGN);
    cmbEN_DACCLKH_CLKGN->SetSelection(value);
...
void pnlCLKGEN::UpdateReadOnlyValues()
{
    ...
    int param;
    param = lmsControl->GetParam(COARSE_STEPDONE);
    lblCOARSE_STEPDONE_CGEN->SetLabel(wxString::Format("%i", param));

    param = lmsControl->GetParam(COARSEPLL_COMPO_CGEN);
...
void pnlCLKGEN::OnbtnReadCMPClick(wxCommandEvent& event)
{
    lmsControl->SetAutoDownload(true);
    int param;
    param = lmsControl->GetParam(VCO_CMPHO_CGEN);
    lblVCO_CMPHO_CGEN->SetLabel(wxString::Format("%i", param));

    param = lmsControl->GetParam(VCO_CMPLO_CGEN);
...
void pnlCLKGEN::OnbtnCalculateClick(wxCommandEvent& event)
{
    ...
    else
    {
        /*lblINT_SDM->SetLabel(wxString::Format("%i", Nint));
        lblFRAC_SDM->SetLabel(wxString::Format("%i", Nfrac));
        //lblDivider->SetLabel(wxString::Format("%i", iDind));
...
{
    dlgVCO_CGEN dlg(lmsControl->getPLL_CGEN(), this);
    dlg.ShowModal();
}

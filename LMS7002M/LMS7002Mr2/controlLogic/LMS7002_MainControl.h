...
// DESCRIPTION:	Header for LMS7002_MainControl.h
// DATE:		2013-11-28
...
class LMS7002_MainControl : public SignalHandler
{
    public:
        ...
        int SetFrequency(const double desFreq_MHz, double &realFreq_MHz, unsigned &Nint, unsigned &Nfrac, unsigned &iVCO, double &Fvco, unsigned &iDind, unsigned &iEnDiv2, int EnDiv2mode = 0);
        double GetFrequency();

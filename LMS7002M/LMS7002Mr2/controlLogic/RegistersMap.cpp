...
{
    //NCO
    m_parameters[OFC_TX].Set(0x0240, 0, 1, 6, true, "OFC_TX");
    m_parameters[SPC_TX].Set(0x0240, 0, 1, 5, true, "SPC_TX");
    m_parameters[SEL_TX].Set(0x0240, 0, 4, 1, true, "SEL_TX");
    m_parameters[MODE_TX].Set(0x0240, 0, 1, 0, true, "MODE_TX");

    m_parameters[OFC_RX].Set(0x0440, 0, 1, 6, true, "OFC_RX");
    m_parameters[SPC_RX].Set(0x0440, 0, 1, 5, true, "SPC_RX");
    m_parameters[SEL_RX].Set(0x0440, 0, 4, 1, true, "SEL_RX");
    m_parameters[MODE_RX].Set(0x0440, 0, 1, 0, true, "MODE_RX");

    //RFE
    m_parameters[CAP_RXMXO_RFE].Set(0x0111, 7, 5, 5, true, "CAP_RXMXO_RFE");
    m_parameters[CCOMP_TIA_RFE].Set(0x0112, 0, 4, 12, true, "CCOMP_TIA_RFE");
    m_parameters[CFB_TIA_RFE].Set(0x0112, 131, 12, 0, true, "CFB_TIA_RFE");
    m_parameters[CGSIN_LNA_RFE].Set(0x0111, 6, 5, 0, true, "CGSIN_LNA_RFE");
    m_parameters[DCOFFI_RFE].Set(0x010e, 0, 7, 7, true, "DCOFFI_RFE");
    m_parameters[DCOFFQ_RFE].Set(0x010e, 0, 7, 0, true, "DCOFFQ_RFE");
    m_parameters[EN_DCOFF_RXFE_RFE].Set(0x010d, 0, 1, 6, true, "EN_DCOFF_RXFE");
    m_parameters[EN_G_RFE].Set(0x010c, 1, 1, 0, true, "EN_G_RFE");
    m_parameters[EN_INSHSW_H_RFE].Set(0x010d, 0, 1, 5, true, "EN_INSHSW_H_RFE");
    m_parameters[EN_INSHSW_LB1_RFE].Set(0x010d, 0, 1, 4, true, "EN_INSHSW_LB1_RFE");
    m_parameters[EN_INSHSW_LB2_RFE].Set(0x010d, 0, 1, 3, true, "EN_INSHSW_LB2_RFE");
    m_parameters[EN_INSHSW_L_RFE].Set(0x010d, 0, 1, 2, true, "EN_INSHSW_L_RFE");
    m_parameters[EN_INSHSW_W_RFE].Set(0x010d, 0, 1, 1, true, "EN_INSHSW_W_RFE");
    ...
    m_parameters[RCOMP_TIA_RFE].Set(0x0114, 5, 4, 5, true, "RCOMP_TIA_RFE");
    m_parameters[RFB_TIA_RFE].Set(0x0114, 13, 5, 0, true, "RFB_TIA_RFE");
    m_parameters[SEL_PATH_RFE].Set(0x010d, 0, 2, 7, true, "SEL_PATH_RFE");


    //RBB
    m_parameters[C_CTL_LPFH_RBB].Set(0x0116, 0, 8, 0, true, "C_CTL_LPFH_RBB");
    m_parameters[C_CTL_LPFL_RBB].Set(0x0117, 20, 11, 0, true, "C_CTL_LPFL_RBB");
    m_parameters[C_CTL_PGA_RBB].Set(0x011a, 2, 9, 0, true, "C_CTL_PGA_RBB");
    ...
    m_parameters[RCC_CTL_LPFH_RBB].Set(0x0116, 0, 3, 8, true, "RCC_CTL_LPFH_RBB");
    ...
    m_parameters[EN_LOOPB_TXPAD_TRF].Set(0x0101, 0, 1, 0, true, "EN_LOOPB_TXPAD_TRF");
    ...
    m_parameters[LOBIASN_TXM_TRF].Set(0x0103, 28, 5, 5, true, "LOBIASN_TXM_TRF");
    m_parameters[LOBIASP_TXX_TRF].Set(0x0103, 16, 5, 0, true, "LOBIASP_TXX_TRF");
    m_parameters[LOSS_LIN_TXPAD_TRF].Set(0x0101, 0, 5, 6, true, "LOSS_LIN_TXPAD_TRF");
    ...
    m_parameters[CCAL_LPFLAD_TBB].Set(0x010a, 8, 5, 8, true, "CCAL_LPFLAD_TBB");
    m_parameters[CG_IAMP_TBB].Set(0x0108, 24, 6, 10, true, "CG_IAMP_TBB");
    ...
    m_parameters[PD_LPFH_TBB].Set(0x0105, 1, 1, 4, true, "PD_LPFH_TBB");
    m_parameters[PD_LPFIAMP_TBB].Set(0x0105, 0, 1, 3, true, "PD_LPFIAMP_TBB");
    m_parameters[PD_LPFLAD_TBB].Set(0x0105, 0, 1, 2, true, "PD_LPFLAD_TBB");
    m_parameters[PD_LPFS5_TBB].Set(0x0105, 0, 1, 1, true, "PD_LPFS5_TBB");
    m_parameters[RCAL_LPFH_TBB].Set(0x0109, 0, 8, 8, true, "RCAL_LPFH_TBB");
    ...
    m_parameters[ISEL_DAC_AFE].Set(0x0082, 0, 3, 13, false, "ISEL_DAC_AFE");
    ...
    m_parameters[PD_RX_AFE2].Set(0x0082, 0, 1, 3, false, "PD_RX_AFE2");
    m_parameters[PD_TX_AFE1].Set(0x0082, 0, 1, 2, false, "PD_TX_AFE1");
    m_parameters[PD_TX_AFE2].Set(0x0082, 0, 1, 1, false, "PD_TX_AFE2");

    //BIAS
    m_parameters[EN_BIAS_MASTER].Set(0x0084, 1, 1, 1, false, "EN_BIAS_MASTER");
    m_parameters[EN_G_BIAS].Set(0x0084, 1, 1, 0, false, "EN_G_BIAS");
    m_parameters[MUX_BIAS_OUT].Set(0x0084, 0, 2, 11, false, "MUX_BIAS_OUT");
    m_parameters[PD_FRP_BIAS].Set(0x0084, 0, 1, 5, false, "PD_FRP_BIAS");
    m_parameters[PD_F_BIAS].Set(0x0084, 0, 1, 4, false, "PD_F_BIAS");
    m_parameters[PD_PTRP_BIAS].Set(0x0084, 0, 1, 3, false, "PD_PTRP_BIAS");
    m_parameters[PD_PT_BIAS].Set(0x0084, 0, 1, 2, false, "PD_PT_BIAS");
    m_parameters[RP_CALIB_BIAS].Set(0x0084, 0, 5, 6, false, "RP_CALIB_BIAS");
    ...
    m_parameters[EN_DACCLKH_CLKGN].Set(0x0086, 0, 1, 11, false, "EN_DACCLKH_CLKGN");
    ...
    m_parameters[EN_SDM_TSTO_CGEN].Set(0x0086, 0, 1, 7, false, "EN_SDM_TSTO_CGEN");
    m_parameters[FRAC_SDM_CGEN].Set(0x0087, 1920, 20, 0, false, "FRAC_SDM_CGEN");
    m_parameters[ICT_VCO_CGEN].Set(0x008b, 12, 5, 9, false, "ICT_VCO_CGEN");
    m_parameters[INT_SDM_CGEN].Set(0x0088, 64, 10, 4, false, "INT_SDM_CGEN");
    ...
    m_parameters[DIV_LOCH].Set(0x011f, 2, 3, 6, true, "DIV_LOCH");
    ...
    m_parameters[EN_SDM_TSTO].Set(0x011c, 0, 1, 7, true, "EN_SDM_TSTO");
    m_parameters[FRAC_SDM].Set(0x011d, 1920, 20, 0, true, "FRAC_SDM");
    m_parameters[ICT_VCO].Set(0x0120, 12, 8, 0, true, "ICT_VCO");
    m_parameters[INT_SDM].Set(0x011e, 64, 10, 4, true, "INT_SDM");
    ...
    m_parameters[PW_DIV2_LOCH].Set(0x011f, 6, 3, 12, true, "PW_DIV2_LOCH");
    m_parameters[PW_DIV4_LOCH].Set(0x011f, 6, 3, 9, true, "PW_DIV4_LOCH");
    ...
    m_parameters[RSEL_LDO_VCO].Set(0x0121, 8, 5, 11, true, "RSEL_LDO_VCO");
    ...
    m_parameters[EN_LDO_DIGIp1].Set(0x00a6, 1, 1, 1, false, "EN_LDO_DIGIp1");
    m_parameters[EN_LDO_DIGIp2].Set(0x00a6, 1, 1, 2, false, "EN_LDO_DIGIp2");
    ...
    m_parameters[EN_LDO_SPIBUF].Set(0x00a6, 1, 1, 3, false, "EN_LDO_SPIBUF");
    ...
    m_parameters[RDIV_VCOGN].Set(0x009a, 101, 8, 0, false, "RDIV_VCOGN");
    ...
    m_parameters[DLB_MUX].Set(0x002a, 0, 1, 7, false, "DLB_MUX");
    ...
    m_parameters[LML1_RX_PRE].Set(0x0026, 1, 8, 0, false, "LML1_RX_PRE");
    m_parameters[LML1_RX_PST].Set(0x0026, 1, 8, 8, false, "LML1_RX_PST");
    ...
    m_parameters[LML1_TX_PRE].Set(0x0025, 1, 8, 0, false, "LML1_TX_PRE");
    m_parameters[LML1_TX_PST].Set(0x0025, 1, 8, 8, false, "LML1_TX_PST");
    ...
    m_parameters[LML2_RX_PRE].Set(0x0029, 1, 8, 0, false, "LML2_RX_PRE");
    m_parameters[LML2_RX_PST].Set(0x0029, 1, 8, 8, false, "LML2_RX_PST");
    ...
    m_parameters[LML2_TX_PRE].Set(0x0028, 1, 8, 0, false, "LML2_TX_PRE");
    m_parameters[LML2_TX_PST].Set(0x0028, 1, 8, 8, false, "LML2_TX_PST");
    m_parameters[LML_MODE1].Set(0x0023, 1, 1, 0, false, "LML_MODE1");
    m_parameters[LML_MODE2].Set(0x0023, 1, 1, 3, false, "LML_MODE2");
    m_parameters[LML_FIDM1].Set(0x0023, 0, 1, 2, false, "LML_FIDM1");
    m_parameters[LML_FIDM2].Set(0x0023, 0, 1, 5, false, "LML_FIDM2");
    m_parameters[LML_TXNRXIQ1].Set(0x0023, 1, 1, 1, false, "LML_TXNRXIQ1");
    m_parameters[LML_TXNRXIQ2].Set(0x0023, 1, 1, 4, false, "LML_TXNRXIQ2");
    ...
    m_parameters[RXRDCLK_MUX].Set(0x002a, 0, 1, 2, false, "RXRDCLK_MUX");
    m_parameters[RXWRCLK_MUX].Set(0x002a, 0, 2, 0, false, "RXWRCLK_MUX");
    ...
    m_parameters[TX_MUX].Set(0x002a, 0, 1, 6, false, "TX_MUX");
    m_parameters[TXNRX1_PE].Set(0x0022, 1, 1, 2, false, "TXNRX1_PE");
    m_parameters[TXNRX2_PE].Set(0x0022, 1, 1, 8, false, "TXNRX2_PE");
    m_parameters[TXRDCLK_MUX].Set(0x002a, 0, 2, 4, false, "TXRDCLK_MUX");
    m_parameters[TXWRCLK_MUX].Set(0x002a, 0, 1, 3, false, "TXWRCLK_MUX");
    ...
    m_parameters[CMIX_P6DB_TXTSP].Set   (0x0208, 0, 1, 15, true, "CMIX_P6DB_TXTSP");
    ...
    //RX TSP
    m_parameters[BSTATE_RXTSP].Set(0x040D, 0, 1, 0, true, "BSTATE_RXTSP");
    m_parameters[BSIGI_RXTSP].Set(0x040D, 0, 23, 1, true, "BSIGI_RXTSP");
    m_parameters[BSIGQ_RXTSP].Set(0x040E, 0, 23, 8, true, "BSIGQ_RXTSP");
    m_parameters[RSSI_RXTSP].Set(0x040B, 0, 16, 0, true, "RSSI_RXTSP");
    m_parameters[AGC_ADESIRED_RXTSP].Set(0x0409, 0, 12, 4, true, "AGC_ADESIRED_RXTSP");
    m_parameters[AGC_AVG_RXTSP].Set(0x040a, 0, 12, 0, true, "AGC_AVG_RXTSP");
    ...
    m_parameters[CMIX_P6DB_RXTSP].Set(0x040c, 0, 1, 15, true, "CMIX_P6DB_RXTSP");
    ...
    m_parameters[CDS_RXALML].Set(0x00af, 0, 2, 0, false, "CDS_RXALML");
    m_parameters[CDS_RXATSP].Set(0x00af, 0, 2, 8, false, "CDS_RXATSP");
    m_parameters[CDS_RXBLML].Set(0x00af, 0, 2, 2, false, "CDS_RXBLML");
    m_parameters[CDS_RXBTSP].Set(0x00af, 0, 2, 10, false, "CDS_RXBTSP");
    m_parameters[CDS_TXALML].Set(0x00af, 0, 2, 4, false, "CDS_TXALML");
    m_parameters[CDS_TXATSP].Set(0x00af, 0, 2, 12, false, "CDS_TXATSP");
    m_parameters[CDS_TXBLML].Set(0x00af, 0, 2, 6, false, "CDS_TXBLML");
    m_parameters[CDS_TXBTSP].Set(0x00af, 0, 2, 14, false, "CDS_TXBTSP");
...
RegistersMap::RegistersMap( ConnectionManager *pConMng) : m_activeChannel(0),
    m_lastActiveChannel(0), m_channelCount(2), m_autoUpload(true), m_autoDownload(false), m_configAllChannels(false)
{
    ...
    m_modulesInfo[AFE] = RegTestPlan("AFE", 0x0082, 0x0084, true);
    m_modulesInfo[BIAS] = RegTestPlan("BIAS", 0x0083, 0x0084, true);
    m_modulesInfo[XBUF] = RegTestPlan("XBUF", 0x0085, 0x0086, true);
    m_modulesInfo[CGEN] = RegTestPlan("CGEN", 0x0086, 0x008D, true);
    m_modulesInfo[LDO] = RegTestPlan("LDO", 0x0092, 0x00A7, true);
    m_modulesInfo[BIST] = RegTestPlan("BIST", 0x00A8, 0x00AD, true);
    m_modulesInfo[CDS] = RegTestPlan("CDS", 0x00AD, 0x00B0, true);
    ...
    m_modulesInfo[SXRSXT] = RegTestPlan("SXR/SXT", 0x011C, 0x0124, true),
    m_modulesInfo[TxTSP] = RegTestPlan("TxTSP", 0x0200, 0x0240-1, true),
    m_modulesInfo[TxNCO] = RegTestPlan("TxNCO", 0x0240, 0x0280-1, true),
    m_modulesInfo[RxTSP] = RegTestPlan("RxTSP", 0x0400, 0x0440-1, true),
    m_modulesInfo[RxNCO] = RegTestPlan("RxNCO", 0x0440, 0x0480-1, true),
...
bool RegistersMap::SetParameterValue(LMS7002_Parameter param, unsigned long value)
{
    ...
    switch(param)
    {
        ...
        case HBD_OVR_RXTSP:
            if(value == 5)
                value = 7; //change value and continue to default handling
...
bool RegistersMap::CheckForOverlays()
{
    ...
    for(int i=0; i<LMS_PARAMETER_COUNT; i++)
    {
        ...
        if(value != 0)
        {
            cout << "Register bits overlapping at address " << int2hex(m_parameters[i].address, 2) << endl;
            status = true;
        }
        ...
        value = GetParameterValue((LMS7002_Parameter)i);
        if(value != mask)
            cout << "writing failed at address " << int2hex(m_parameters[i].address, 2) << "   set value " << mask << "  read value " << value << endl;
    }
//    SetAutoUpload(true);
...
bool RegistersMap::RegisterTest()
{
    ...
    RegTestPlan testsCommon[testsCommonCount] =
    {
        ...
        RegTestPlan("AFE", 0x0082, 0x0084, true),
        RegTestPlan("BIAS", 0x0083, 0x0084, true),
        RegTestPlan("XBUF", 0x0085, 0x0086, true),
        RegTestPlan("CGEN", 0x0086, 0x008D, true),
        RegTestPlan("LDO", 0x0092, 0x00A7, true),
        RegTestPlan("BIST", 0x00A8, 0x00AD, true),
        RegTestPlan("CDS", 0x00AD, 0x00B0, true)
    };

    const int testsChannelsCount = 19;
    RegTestPlan testsChannels[testsChannelsCount] =
    {
        RegTestPlan("TRF channel", 0x0100, 0x0104, true),
        RegTestPlan("TBB channel", 0x0105, 0x010B, true),
        RegTestPlan("RFE channel", 0x010C, 0x0114, true),
        RegTestPlan("RBB channel", 0x0115, 0x011B, true),
        RegTestPlan("SXR/SXT channel", 0x011C, 0x0124, true),
        RegTestPlan("TxTSP", 0x0200, 0x0240-1, true),
        RegTestPlan("TxNCO", 0x0240, 0x0280-1, true),
        RegTestPlan("TxGFIR1", 0x0280, 0x02C0-1, false),
        RegTestPlan("TxGFIR2", 0x02C0, 0x0300-1, false),
        RegTestPlan("TxGFIR3a", 0x0300, 0x0340-1, false),
        RegTestPlan("TxGFIR3b", 0x0340, 0x0380-1, false),
        RegTestPlan("TxGFIR3c", 0x0380, 0x0400-1, false),

        RegTestPlan("RxTSP", 0x0400, 0x0440-1, true),
        RegTestPlan("RxNCO", 0x0440, 0x0480-1, true),
        RegTestPlan("RxGFIR1", 0x0480, 0x04C0-1, false),
        RegTestPlan("RxGFIR2", 0x04C0, 0x0500-1, false),
        RegTestPlan("RxGFIR3a", 0x0500, 0x0540-1, false),
        RegTestPlan("RxGFIR3b", 0x0540, 0x0580-1, false),
        RegTestPlan("RxGFIR3c", 0x0580, 0x0600-1, false),
    };
    ...
    {
        retVal = TestRegistersWithinRange( testsChannels[i].name, testsChannels[i].startAddr, testsChannels[i].endAddr, testsChannels[i].onlyUsedAddresses);
        if( retVal >= 0)
            status &= retVal;
        else
            return false;
...
#warning this condition is needed not to change SPI mode, or latter tests will fail
            ...
            {
                writtenBuffer.push_back(testPatterns[p] | 0x0001);
            }
            else
                writtenBuffer.push_back(testPatterns[p]);
        }
        ...
        {
            if( inBuffer[1+i*2] != writtenBuffer[1+i*2])
            {
...
#warning this condition is needed not to change SPI mode, or latter tests will fail
        if(usedRegs[i].address == 0x0021)
        {
            writtenBuffer.push_back(pattern | 0x0001);
        }
        else
            writtenBuffer.push_back(pattern);
    }
    unsigned long bytesToSend, bytesToRead;
    bytesToSend = writtenBuffer.size()*sizeof(unsigned short);
    bytesToRead = bytesToSend*2;
